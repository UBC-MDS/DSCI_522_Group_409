...
# Description
The dataset we chose is the Bike Sharing Dataset from @uic_mlr. This dataset contains the hourly and daily count of rental bikes in 2011 and 2012 in Capital bikeshare system in Washington, DC with the corresponding weather and seasonal information. It is provided by @hadi, Laboratory of Artificial Intelligence and Decision Support (LIAAD), University of Porto.  
