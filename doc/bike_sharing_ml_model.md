...
The dataset was created by Dr. Hadi @hadi from the Laboratory of Artificial Intelligence and Decision Support (LIAAD), at the UCI Machine Learning Repository, and can be found [here](https://archive.ics.uci.edu/ml/datasets/bike+sharing+dataset).
